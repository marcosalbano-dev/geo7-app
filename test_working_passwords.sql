-- Script para testar com senhas que sabemos que funcionam
-- Vamos usar senhas com hash bcrypt força 10 (padrão do Spring Boot)

-- OPÇÃO 1: Senha 'admin123' (hash bcrypt força 10)
UPDATE public.users 
SET password = '$2a$10$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj4J/8KzKz2K'
WHERE email = 'marcosalbano@email.com';

-- OPÇÃO 2: Senha 'user123' (hash bcrypt força 10)
-- UPDATE public.users 
-- SET password = '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi'
-- WHERE email = 'marcosalbano@email.com';

-- OPÇÃO 3: Senha '123456' (hash bcrypt força 10 - diferente do anterior)
-- UPDATE public.users 
